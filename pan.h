...
#define PanSource	"frogcrossing-starter.txt"
...
#define _nstates2	11	/* goal */
#define minseq2	101
#define maxseq2	110
#define _endstate2	10

#define _nstates1	81	/* move_frogs */
#define minseq1	21
#define maxseq1	100
#define _endstate1	80

#define _nstates0	22	/* :init: */
#define minseq0	0
#define maxseq0	20
...
#define Pmove_frogs	((P1 *)_this)
typedef struct P1 { /* move_frogs */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
